...
from db.db_func import change_server_status_in_db, remove_server_status, return_server_status, check_server_status_null
...
def create_main_menu(window: tk.Tk):
    # create server status in db
    if check_server_status_null() == 0:
        change_server_status_in_db()
